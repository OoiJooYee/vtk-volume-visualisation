...
int main(int argc, char** argv)
{
	...
	// Adding opacity points
	isoOpacityTransferFunction->AddPoint(0, 0.0);
	isoOpacityTransferFunction->AddPoint(1000, 0.2);
	isoOpacityTransferFunction->AddPoint(3000, 0.5);
	isoOpacityTransferFunction->AddPoint(5000, 0.8);
	isoOpacityTransferFunction->AddPoint(8000, 0.9);
	isoOpacityTransferFunction->AddPoint(12000, 0.5);
	isoOpacityTransferFunction->AddPoint(15000, 0.3);
	...
	// Adding RGB points
	isoColorTransferFunction->AddRGBPoint(0.0, 0.0, 0.0, 0.0);          // Transparent
	isoColorTransferFunction->AddRGBPoint(1000.0, 0.5, 0.5, 1.0);      // Blue
	isoColorTransferFunction->AddRGBPoint(3000.0, 1.0, 0.5, 0.5);      // Red
	isoColorTransferFunction->AddRGBPoint(5000.0, 0.8, 1.0, 0.8);      // Green
	isoColorTransferFunction->AddRGBPoint(8000.0, 1.0, 1.0, 0.5);      // Yellow
	isoColorTransferFunction->AddRGBPoint(10000.0, 1.0, 0.5, 0.5);     // Orange
	isoColorTransferFunction->AddRGBPoint(15000.0, 0.5, 0.0, 0.5);     // Purple
	...
	aRenderer->SetBackground(0.44,0.50,0.56);
