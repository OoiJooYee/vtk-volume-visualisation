...
int main(int argc, char** argv)
{
	...
	isoOpacityTransferFunction->AddPoint(1000, 0.3);
	isoOpacityTransferFunction->AddPoint(3000, 0.5);
	isoOpacityTransferFunction->AddPoint(6000, 0.7);
	isoOpacityTransferFunction->AddPoint(10000, 0.9);
	...
	isoColorTransferFunction->AddRGBPoint(1000.0, 0.5, 1.0, 0.0);     // Green
	isoColorTransferFunction->AddRGBPoint(3000.0, 0.3, 0.24, 0.55);   // Purple
	isoColorTransferFunction->AddRGBPoint(6000.0, 0.94, 0.5, 0.5);    // Pink
	isoColorTransferFunction->AddRGBPoint(10000.0, 0.9, 0.9, 0.9);    // Light gray
